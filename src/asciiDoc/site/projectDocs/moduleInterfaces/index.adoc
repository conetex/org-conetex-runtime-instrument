...
* *Implementing counters or cost metrics* +
 Implemented in: xref:../moduleCounter/index.adoc#purpose[`counter`], xref:../../../metrics-cost/index.adoc#purpose[`metrics-cost`]
...
* *Performing bytecode transformation* +
 Implemented in: xref:../moduleMetrics-cost/index.adoc#purpose[`metrics-cost`], xref:../../../metrics-cost-unnamed/index.adoc#purpose[`metrics-cost-unnamed`], xref:../moduleCounter/index.adoc#purpose[`counter`]
